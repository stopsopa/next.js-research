...
if ( typeof process.env.JWT_SECRET !== 'string' ) {
    ...
    throw new Error(`jwtCookie.js: process.env.JWT_SECRET !== 'string'`);
}

if ( ! process.env.JWT_SECRET.trim() ) {

    throw new Error(`jwtCookie.js: process.env.JWT_SECRET is empty string`);
}

if ( typeof process.env.NEXT_PUBLIC_JWT_COOKIE_NAME !== 'string' ) {

    throw new Error(`jwtCookie.js: process.env.NEXT_PUBLIC_JWT_COOKIE_NAME !== 'string'`);
}

if ( ! process.env.NEXT_PUBLIC_JWT_COOKIE_NAME.trim() ) {

    throw new Error(`jwtCookie.js: process.env.NEXT_PUBLIC_JWT_COOKIE_NAME is empty string`);
}

if ( typeof process.env.NEXT_PUBLIC_JWT_EXPIRE_IN_SEC !== 'string' ) {

    throw new Error(`jwtCookie.js: process.env.NEXT_PUBLIC_JWT_EXPIRE_IN_SEC !== 'string'`);
}

if ( ! process.env.NEXT_PUBLIC_JWT_EXPIRE_IN_SEC.trim() ) {

    throw new Error(`jwtCookie.js: process.env.NEXT_PUBLIC_JWT_EXPIRE_IN_SEC is empty string`);
}
...
if ( NEXT_PUBLIC_JWT_EXPIRE_IN_SEC < 1 ) {
    ...
    throw new Error(`jwtCookie.js: NEXT_PUBLIC_JWT_EXPIRE_IN_SEC < 1`);
}
